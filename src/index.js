...
function getArtistTrack(track) {
  return track.show ? track.show.publisher : [track.artists];
...
module.exports = (fetch) => {
  ...
  return {
    ...
    getAllData: async (url, opts) => {
      const originalData = await getData(url, opts);
      return {
        processedData: getPreview(originalData),
        originalData
      };
    },
  };
